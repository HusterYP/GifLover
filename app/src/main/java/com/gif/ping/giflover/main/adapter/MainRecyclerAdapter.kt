...
import com.gif.ping.giflover.play.view.GifPlayerActivity
...
class MainRecyclerAdapter(val context: Context, val gifBeans: GifBeans) :
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        (p0.item_img.parent as View).setOnClickListener {
            ...
            intent.putExtra(GifPlayerActivity.CUR_URL, gifBeans.gifs[p1])
            intent.putExtra(GifPlayerActivity.PAGE, gifBeans.gifs[p1].page)
            intent.putExtra(GifPlayerActivity.TAG, gifBeans.tag)
